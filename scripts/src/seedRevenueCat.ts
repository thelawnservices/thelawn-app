...
const PROJECT_NAME = "TheLawnServices";

const PRODUCT_IDENTIFIER = "lawn_pro_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "lawn_pro_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Lawn Pro Monthly";
const PRODUCT_USER_FACING_TITLE = "Lawn Pro Monthly";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "TheLawnServices iOS";
const APP_STORE_BUNDLE_ID = "com.thelawnservices.ios";
const PLAY_STORE_APP_NAME = "TheLawnServices Android";
const PLAY_STORE_PACKAGE_NAME = "com.thelawnservices.android";
