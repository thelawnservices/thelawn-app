/**
 * Stripe client using the Replit Stripe connector integration.
 * Credentials are fetched dynamically from the Replit connectors service —
 * never cached; always call getUncachableStripeClient() fresh per request.
 */
